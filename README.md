...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/refet-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/refet-feedstock)
...
Once the `conda-forge` channel has been enabled, `refet` can be installed with:

```
conda install refet
```

It is possible to list all of the versions of `refet` available on your platform with:
